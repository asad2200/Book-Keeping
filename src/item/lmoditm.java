 ...
 * @author ASAD
 */
public class lmoditm extends javax.swing.JDialog {
    
    static Point rr;
    static Dimension d1;
    static DbConnection db;
    Controller cntrl;
    public lmoditm(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("List of Items");
        ...
        jLabel2.setText("Select Item For Modification");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_search_30px_3.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        cntrl.lmoditmmod(jTable1, this, rr, d1);
    ...
    private void txtnameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnameKeyReleased
        cntrl.fetchitemsforSearchbar(jTable1,txtname.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lmoditm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              lmoditm dialog = new lmoditm(new javax.swing.JFrame(),true,rr,d1,db);
