 ...
 * @author ASAD
 */
public class itmmod extends javax.swing.JDialog {
    ...
    public itmmod(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String itmname,JTable jTable1,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        ...
        seq=cntrl.setitemdetail(itmname, txtname, listgroup, listunit, txthsn,txtsale, txtpurcahse);
    ...
    private void initComponents() {
        ...
        txtpurcahse = new javax.swing.JTextField();
        listunit = new javax.swing.JComboBox();
        ...
        listgroup.setBackground(new java.awt.Color(38, 115, 103));
        listgroup.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Genral", " " }));
        listgroup.setToolTipText("select country");
        listgroup.setDoubleBuffered(true);
        listgroup.setOpaque(false);
        listgroup.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                listgroupActionPerformed(evt);
            }
        });
        ...
        txtsale.setBackground(new java.awt.Color(38, 115, 103));
        txtsale.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        txtsale.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txtpurcahse.setBackground(new java.awt.Color(38, 115, 103));
        txtpurcahse.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        txtpurcahse.setForeground(new java.awt.Color(255, 255, 255));
        txtpurcahse.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtpurcahseActionPerformed(evt);
            }
        });

        listunit.setBackground(new java.awt.Color(38, 115, 103));
        listunit.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pcs.", "Box", " " }));
        listunit.setToolTipText("select country");
        listunit.setDoubleBuffered(true);
        listunit.setOpaque(false);
        listunit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                listunitActionPerformed(evt);
            }
        });

        txthsn.setBackground(new java.awt.Color(38, 115, 103));
        txthsn.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        txthsn.setForeground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(listgroup, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(listunit, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel13, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtsale, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtpurcahse, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel17, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txthsn, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(10, 10, 10))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(listgroup, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(listunit, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtsale, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtpurcahse, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        cntrl.itmmod(txtname, listgroup, listunit, txthsn, txtsale, txtpurcahse, this, seq, jTable1);
    ...
    private void listgroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listgroupActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_listgroupActionPerformed
    ...
    private void txtpurcahseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtpurcahseActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtpurcahseActionPerformed
    ...
    private void listunitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listunitActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_listunitActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(itmmod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              itmmod dialog = new itmmod(new javax.swing.JFrame(),true,rr,d1,itmname,jTable1,db);
    ...
    private javax.swing.JComboBox listgroup;
    private javax.swing.JComboBox listunit;
    private javax.swing.JTextField txthsn;
    private javax.swing.JTextField txtname;
    private javax.swing.JTextField txtpurcahse;
