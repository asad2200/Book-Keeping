 ...
 * @author ASAD
 */
public class itmadd extends javax.swing.JDialog {
...
//    static int j=0,k=0;
    ...
    Controller cntrl;
    public itmadd(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_add_shopping_cart_30px.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        cntrl.itmadd(txtname, listgroup, listunit, txthsn,txtsale, txtpurcahse, this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(itmadd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              itmadd dialog = new itmadd(new javax.swing.JFrame(),true,rr,d1,db);
