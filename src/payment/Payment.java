...
public class Payment extends javax.swing.JDialog {
    ...
    public Payment(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db) {
        super(parent, modal);
        initComponents();
        rr=rv;
        d1=d;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Add Payment Vouchar");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
         if(Double.parseDouble(lblcredit.getText())==Double.parseDouble(lbldebit.getText())){
           cntrl.savePayment(txtvchno.getText(),datef.format(paymentDate.getDate()), tblAccount,modeltbl);
           lbldebit.setText("00.00");
           lblcredit.setText("00.00");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Payment dialog = new Payment(new javax.swing.JFrame(), true,rr,d1,db);
