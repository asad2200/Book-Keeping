 ...
 * @author ASAD
 */
public class LmodPayment extends javax.swing.JDialog {
    ...
    Frame f;
    public LmodPayment(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        f=parent;
        rr=rv;
        d1=d;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         if(jTable1.getSelectedRow()<0)
            ...
            new ModPayment(f,true,rr,d1,data,db).show();
         }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
       cntrl.fetchpaymentswithdate(jTable1,date.format(sdate.getDate()),date.format(edate.getDate()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              LmodPayment dialog = new LmodPayment(new javax.swing.JFrame(),true,rr,d1,db);
