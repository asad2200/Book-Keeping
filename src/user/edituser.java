...
//    static int j=0;
    ...
    public edituser(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String s,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_registration_30px.png"))); // NOI18N
        jLabel3.setText("Modify User");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        cntrl.moduser(txtname, txtpass1, this, cmpname);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                edituser dialog = new edituser(new javax.swing.JFrame(), true,rr,d1,cmpname,db);
