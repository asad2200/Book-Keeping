 ...
 * @author asadj
 */
public class IgstSaleReturn extends javax.swing.JDialog {

    /**
     * Creates new form IgstSale
     */
    static Object obj[];
    public IgstSaleReturn(java.awt.Dialog parent, boolean modal,Object obj[]) {
        super(parent, modal);
        initComponents();
        this.obj=obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IgstSaleReturn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IgstSaleReturn dialog = new IgstSaleReturn(new javax.swing.JDialog(), true,obj);
