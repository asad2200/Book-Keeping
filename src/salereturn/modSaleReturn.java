 ...
 * @author ASAD
 */
public class modSaleReturn extends javax.swing.JDialog {
...
//    int cases=0;
    ...
    public modSaleReturn(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String billno,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
    ...
    public JTable tbl(){
         try {
            ...
            java.util.logging.Logger.getLogger(modSaleReturn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
         JTable jTable1=new javax.swing.JTable();
         try {
            UIManager.setLookAndFeel(new FlatIntelliJLaf());
        } catch (UnsupportedLookAndFeelException ex) {
            Logger.getLogger(modSaleReturn.class.getName()).log(Level.SEVERE, null, ex);
        }
//         try {
//            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Sale-Return Vouchar");
       ...
       if(saleType.getSelectedItem()=="None" || saleType.getSelectedItem()=="Regular" || saleType.getSelectedItem()=="CESS"){
        if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
           ...
           if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
            ...
            GstSaleReturn dlg=new GstSaleReturn(this, true,obj);
            obj = dlg.showDialog();
            data[7]=obj[1];
            data[8]=obj[2];
            data[9]=obj[3];
           ...
           if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
            ...
            IgstSaleReturn dlg=new IgstSaleReturn(this, true,obj);
            obj = dlg.showDialog();
            data[11]=obj[1];
            data[12]=obj[2];
            data[13]=obj[3];
...
//             UIManager.setLookAndFeel(new FlatIntelliJLaf());
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              modSaleReturn dialog = new modSaleReturn(new javax.swing.JFrame(),true,rr,d1,billno,db);
