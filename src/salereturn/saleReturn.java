 ...
 * @author ASAD
 */
public class saleReturn extends javax.swing.JDialog {
...
//    int cases=0;
    ...
    public saleReturn(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
        ...
        int n=cntrl.setbillno();
        txtbillno.setText(Integer.toString(n));
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Sale-Return Vouchar");
...
//             UIManager.setLookAndFeel(new FlatIntelliJLaf());
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              saleReturn dialog = new saleReturn(new javax.swing.JFrame(),true,rr,d1,db);
