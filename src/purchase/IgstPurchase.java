 ...
 * @author asadj
 */
public class IgstPurchase extends javax.swing.JDialog {

    /**
     * Creates new form IgstSale
     */
    static Object obj[];
    public IgstPurchase(java.awt.Dialog parent, boolean modal,Object obj[]) {
        super(parent, modal);
        initComponents();
        this.obj=obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IgstPurchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IgstPurchase dialog = new IgstPurchase(new javax.swing.JDialog(), true,obj);
