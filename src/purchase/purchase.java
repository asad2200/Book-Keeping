...
//    int cases=0;
    ...
    public purchase(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Purchase Vouchar");
...
//             UIManager.setLookAndFeel(new FlatIntelliJLaf());
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              purchase dialog = new purchase(new javax.swing.JFrame(),true,rr,d1,db);
