 ...
 * @author asadj
 */
public class ModReceipt extends javax.swing.JDialog {
    ...
    public ModReceipt(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String data[],DbConnection db) {
        super(parent, modal);
        initComponents();
        rr=rv;
        d1=d;
         ...
         try {
            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
               if ("Windows".equals(info.getName())) {
                ...
                java.util.logging.Logger.getLogger(LmodReceipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }
             JTable jTable1=new javax.swing.JTable();
             try {
                UIManager.setLookAndFeel(new FlatIntelliJLaf());
            } catch (UnsupportedLookAndFeelException ex) {
                Logger.getLogger(LmodReceipt.class.getName()).log(Level.SEVERE, null, ex);
            }
         return jTable1;
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Modify Receipt Vouchar");
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        try {
            ...
            Logger.getLogger(ModReceipt.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
         if(Double.parseDouble(lblcredit.getText())==Double.parseDouble(lbldebit.getText())){
           cntrl.updateReceipt(txtvchno.getText(),datef.format(paymentDate.getDate()),tblAccount,modeltbl,accountname1,amount1,accountname2,amount2);
           this.dispose();
         }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModReceipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModReceipt dialog = new ModReceipt(new javax.swing.JFrame(), true,rr,d1,data,db);
