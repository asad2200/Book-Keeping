...
public class Receipt extends javax.swing.JDialog {
    ...
    public Receipt(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db) {
        super(parent, modal);
        initComponents();
        rr=rv;
        d1=d;
        ...
        txtvchno.setText(Integer.toString(n));
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Add Receipt Vouchar");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
         if(Double.parseDouble(lblcredit.getText())==Double.parseDouble(lbldebit.getText())){
           cntrl.saveReceipt(txtvchno.getText(),datef.format(paymentDate.getDate()), tblAccount,modeltbl);
           lbldebit.setText("00.00");
           lblcredit.setText("00.00");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Receipt dialog = new Receipt(new javax.swing.JFrame(), true,rr,d1,db);
