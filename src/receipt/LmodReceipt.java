 ...
 * @author ASAD
 */
public class LmodReceipt extends javax.swing.JDialog {
    ...
    Frame f;
    public LmodReceipt(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        f=parent;
        rr=rv;
        d1=d;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(btnaccdetail, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         if(jTable1.getSelectedRow()<0)
            ...
            data[0]=(String)jTable1.getValueAt(jTable1.getSelectedRow(),0);
            data[1]=(String)jTable1.getValueAt(jTable1.getSelectedRow(),2);
            new ModReceipt(f,true,rr,d1,data,db).show();
         }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
       cntrl.fetchreceiptswithdate(jTable1,date.format(sdate.getDate()),date.format(edate.getDate()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              LmodReceipt dialog = new LmodReceipt(new javax.swing.JFrame(),true,rr,d1,db);
