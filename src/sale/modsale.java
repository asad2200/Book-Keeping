 ...
 * @author ASAD
 */
public class modsale extends javax.swing.JDialog {
...
//    int cases=0;
    ...
    public modsale(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String billno,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
    ...
    public JTable tbl(){
         try {
            ...
            java.util.logging.Logger.getLogger(modsale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
         JTable jTable1=new javax.swing.JTable();
         try {
            UIManager.setLookAndFeel(new FlatIntelliJLaf());
        } catch (UnsupportedLookAndFeelException ex) {
            Logger.getLogger(modsale.class.getName()).log(Level.SEVERE, null, ex);
        }
//         try {
//            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Sale Vouchar");
    ...
    private void txtbillnoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtbillnoFocusGained
        ...
        txtbillno.setBackground(c);
        txtbillno.setForeground(Color.WHITE);
    ...
    private void txtbillnoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtbillnoFocusLost
        ...
        txtbillno.setBackground(c);
        txtbillno.setForeground(Color.BLACK);
       ...
       if(saleType.getSelectedItem()=="None" || saleType.getSelectedItem()=="Regular" || saleType.getSelectedItem()=="CESS"){
        if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
           ...
           if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
            ...
            GstSale dlg=new GstSale(this, true,obj);
            obj = dlg.showDialog();
            data[7]=obj[1];
            data[8]=obj[2];
            data[9]=obj[3];
           ...
           if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
            ...
            IgstSale dlg=new IgstSale(this, true,obj);
            obj = dlg.showDialog();
            data[11]=obj[1];
            data[12]=obj[2];
            data[13]=obj[3];
...
//            String str = String.format("%.2f",value);
    ...
    private void btndeletebillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeletebillActionPerformed
        int n=JOptionPane.showConfirmDialog(this,"Do you want to delete this?", "Delete?", JOptionPane.YES_NO_CANCEL_OPTION,3);
                if(n==JOptionPane.YES_OPTION){
                    cntrl.dltBill(txtbillno.getText(),itemname,itemqty);
...
//             UIManager.setLookAndFeel(new FlatIntelliJLaf());
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              modsale dialog = new modsale(new javax.swing.JFrame(),true,rr,d1,billno,db);
