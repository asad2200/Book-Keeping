 ...
 * @author ASAD
 */
public class lmodsale extends javax.swing.JDialog {
...
//    static int j=0,k=0;
    ...
    public lmodsale(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String cmpname,DbConnection db){
        super(parent, modal);
        f=parent;
        rr=rv;
        d1=d;
    ...
    private void jLabel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MouseClicked
        try {
            ...
            Logger.getLogger(lmodsale.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(jTable1.getSelectedRow()<0)
            ...
            new modsale(f,true,rr,d1,(String)jTable1.getValueAt(jTable1.getSelectedRow(),0),db).show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lmodsale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              lmodsale dialog = new lmodsale(new javax.swing.JFrame(),true,rr,d1,cname,db);
