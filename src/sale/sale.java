...
//    int cases=0;
    ...
    public sale(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Sale Vouchar");
...
//             UIManager.setLookAndFeel(new FlatIntelliJLaf());
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              sale dialog = new sale(new javax.swing.JFrame(),true,rr,d1,db);
