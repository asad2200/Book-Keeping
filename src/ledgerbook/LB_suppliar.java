 ...
 * @author ASAD
 */
public class LB_suppliar extends javax.swing.JDialog {
...
//    static int j=0,k=0;
    ...
    public LB_suppliar(java.awt.Frame parent, boolean modal,Point rv,Dimension d,DbConnection db){
        super(parent, modal);
        f=parent;
        rr=rv;
        d1=d;
        ...
        cntrl.fetchaccountsforsuppliar(jname);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Ledger Book Suppliar");
        ...
        jLabel7.setText("PAYMENT / PURCHASE RETURN BILL");
        ...
        jLabel5.setText("\"-\"  -   suppliar ne aapvana  baki");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel8.setText("\"+\" -   suppliar pase aapda jama");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        cntrl.fetchpurchasebills(jTable1,jname.getSelectedItem().toString(),date.format(sdate.getDate()),date.format(edate.getDate()));
        cntrl.fetchreturnpayments(jTable2,jname.getSelectedItem().toString(),date.format(sdate.getDate()),date.format(edate.getDate()));
