 ...
 * @author ASAD
 */
public class modPurchaseReturn extends javax.swing.JDialog {
...
//    int cases=0;
    ...
    public modPurchaseReturn(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String billno,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
        ...
        jname.getEditor().getEditorComponent().addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent evt){
                ...
                if(!txtbillno.getText().equals("")){
                    String s=cntrl.checkBillnoList(txtbillno,jname.getSelectedItem().toString());
                    if(s.equals("Not Available")){
                        JOptionPane.showMessageDialog(null,"This billno not available in "+jname.getSelectedItem().toString()+". change the purchase bill no","Not Available",2);
                        txtbillno.requestFocusInWindow();
                    }
                }else{
                    JOptionPane.showMessageDialog(null,"Bill can not be empty.\n Enter bill no.","Can't be Empty..!",2);
                }
            }
        });
    ...
    public JTable tbl(){
         try {
            ...
            java.util.logging.Logger.getLogger(modPurchaseReturn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
         JTable jTable1=new javax.swing.JTable();
         try {
            UIManager.setLookAndFeel(new FlatIntelliJLaf());
        } catch (UnsupportedLookAndFeelException ex) {
            Logger.getLogger(modPurchaseReturn.class.getName()).log(Level.SEVERE, null, ex);
        }
//         try {
//            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Purchase-Return Vouchar");
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        int n=JOptionPane.showConfirmDialog(this,"Do you want to close this?", "Close?", JOptionPane.YES_NO_OPTION,3);
    ...
    private void txtbillnoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtbillnoFocusLost
        if(!txtbillno.getText().equals("") && !oldbillno.equals(txtbillno.getText())){
            String S=cntrl.checkBillno(txtbillno,jname.getSelectedItem().toString());
            if(!S.equals("") && !S.equals("Not Available"))
                JOptionPane.showMessageDialog(this,S,"Available..!",2);
            else if(S.equals("Not Available")){
                JOptionPane.showMessageDialog(this,"This bill no is not available in purchase bill.(change the billno)","Not Available..!",2);
                txtbillno.requestFocusInWindow();
            }
        }
...
//        }
       ...
       if(saleType.getSelectedItem()=="None" || saleType.getSelectedItem()=="Regular" || saleType.getSelectedItem()=="CESS"){
        if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
           ...
           if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
            ...
            GstPurchaseReturn dlg=new GstPurchaseReturn(this, true,obj);
            obj = dlg.showDialog();
            data[7]=obj[1];
            data[8]=obj[2];
            data[9]=obj[3];
           ...
           if(!jitemlist.getSelectedItem().toString().equals("") && !txtqty.getText().equals("") && !txtprice.getText().equals("") && !txtamount.getText().equals("")){
            ...
            IgstPurchaseReturn dlg=new IgstPurchaseReturn(this, true,obj);
            obj = dlg.showDialog();
            data[11]=obj[1];
            data[12]=obj[2];
            data[13]=obj[3];
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(jname.getSelectedItem()!="" && !txtbillno.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(this,"Check partyname and bill no.\n they can't be empty","check!",1); 
        }
...
//             UIManager.setLookAndFeel(new FlatIntelliJLaf());
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              modPurchaseReturn dialog = new modPurchaseReturn(new javax.swing.JFrame(),true,rr,d1,billno,db);
