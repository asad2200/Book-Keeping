 ...
 * @author ASAD
 */
public class accmod extends javax.swing.JDialog {
    ...
    static Point rr;
    static Dimension d1;
    static String aname,seq;
    static JTable jTable1;
    
    static DbConnection db;
    Controller cntrl;
    public accmod(java.awt.Frame parent, boolean modal,Point rv,Dimension d,String accname,JTable jTable,DbConnection db){
        super(parent, modal);
        rr=rv;
        d1=d;
        initComponents();
        ...
        aname=accname;
        jTable1=jTable;
        seq=cntrl.setaccountdetail(aname, txtname, taadd, txtmno, this, listcountry, listtype, liststate,txtgstno);
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_registration_30px.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        cntrl.accmod(txtname, taadd, txtmno, this, listcountry, listtype, liststate, seq,jTable1,aname,txtgstno);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(accmod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              accmod dialog = new accmod(new javax.swing.JFrame(),true,rr,d1,aname,jTable1,db);
